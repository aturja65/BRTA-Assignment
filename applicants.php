...
<nav class="navbar navbar-expand-lg fixed-top portfolio-navbar gradient navbar-dark" style="background: rgb(0,0,0);">
    ...
    <main class="page projets-page">
        <section>
            <div style="margin-top: 33px;text-align: center;"><button class="btn btn-dark" type="button" onclick="addAdmin()" style="border-radius: 4px;text-align: left;padding-left: 30px;padding-right: 30px;margin-right: 10px;">Add Admin</button><button class="btn btn-dark" type="button" onclick="logout()" style="border-radius: 4px;text-align: left;padding-left: 40px;padding-right: 40px;margin-left: 10px;">Logout</button></div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="project-card-no-image"><img style="border-radius: 11px;margin: 0px;margin-bottom: 12px;" width="100" height="80" src="<?php echo $row["profile_pic"]; ?>" >
                            <h3><?php echo $row["name"]; ?></h3><a class="btn btn-outline-dark btn-bg" role="button" href="./applicants_details.php?applicants_email=<?php echo $row["email"]; ?>">Details</a>
                        </div>
                    </div>
                    <?php 
                    }
