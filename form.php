        ...
        <section class="portfolio-block contact">
            <div class="container">
                ...
                <form class="shadow-lg" data-bs-theme="light" method="post" , enctype="multipart/form-data">
                    ...
                    ?>
                    <div class="mb-3"><label class="form-label" for="name">Name</label><input class="form-control item" placeholder="Enter your name" type="text" id="name" name="name" required></div>
                    <div class="mb-3"><label class="form-label" for="subject">NID</label><input class="form-control item" placeholder="Enter your NID no." type="text" id="nid" name="nid" required></div>
                    <div class="mb-3"><label class="form-label" for="email">Email Address</label><input class="form-control item" placeholder="Enter your address" type="email" id="email" name="email" required></div>
                    <div class="mb-3"><label class="form-label" for="name">Vehicle No</label><input class="form-control item" placeholder="Enter vehicle no." type="text" id="vehicleNo" name="vehicleNo" required></div>
                    <div class="mb-3"><label class="form-label" for="name">Vehicle Chassis No</label><input class="form-control item" placeholder="Enter chassis no." type="text" id="chassisNo" name="chassisNo" required></div>
                    <div class="mb-3"><label class="form-label" for="name">Present Address</label><input class="form-control item" placeholder="Enter present address" type="text" id="presentAddress" name="presentAddress" required></div>
                    <div class="mb-3"><label class="form-label" for="name">Permanent Address</label><input class="form-control item" placeholder="Enter permanent address" type="text" id="permanentAddress" name="permanentAddress" required></div>
                    ...
                    <div class="mb-3 mt-4"><button onclick="validateFormPHP()" class="btn btn-dark" name="submit_btn" type="submit">Submit</button></div>
